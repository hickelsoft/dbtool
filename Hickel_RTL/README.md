...
As these features are proprietary, they are not included in the Open Source release of DBTool.
Therefore, the corresponding methods are replaced with dummy implementations.
