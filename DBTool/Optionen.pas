...
procedure TDLG_Optionen.MakeStandard(Ext, Type_, DisplayName,
  MessageName: string);
var
  aReg: TRegistry;
resourcestring
  SDBToolDefaultInstalled =
    'DBTool wurde als Standard-Anwendung für %s eingerichtet.';
  SDefaultErrorNoAdmin =
    'Fehler beim Setzen der Standard-Anwendung. Eventuell muss DBTool mit Administrator-Rechten gestartet werden.';
begin
  ...
  try
    ...
    on E: Exception do
    begin
      Application.MessageBox(PChar(SDefaultErrorNoAdmin),
